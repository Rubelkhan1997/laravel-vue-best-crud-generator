...
╚══════════════════════════════════════════════════════════╝
    ...
    protected function collectFields(): void
    {
        ...
        info("If third parameter is missing, it WILL be required by default");
    ...
    protected function parseFieldDefinitions(string $input): array
    {
        ...
        foreach ($rawItems as $rawItem) {
            ...
            $isRequired = empty($constraints) || in_array('required', $constraints, true);
            ...
            $fields[] = [
                ...
                'required' => $isRequired && !in_array('nullable', $constraints, true),
